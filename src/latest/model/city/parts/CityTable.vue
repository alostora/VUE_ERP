<template>
  <div class="p-3">
    <div class="mb-3">
      <h2 class="m-0">{{ $t("cities.title") }}</h2>
      ...
      <p v-else-if="country_id && !governorate_id" class="text-color-secondary">
...
export default {
  ...
  computed: {
    ...
    filteredGovernorates() {
      ...
      return this.governorates.filter(g => 
        g.country_id === (this.selectedCountry || this.country_id)
      );
    }
  },
