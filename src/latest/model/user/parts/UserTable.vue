        ...
        >
          <template #body="slotProps">
            <div class="table-actions-cell">
              <Button
                icon="pi pi-pencil"
                class="table-action-btn table-action-edit p-button-primary"
                @click="editUserModal(slotProps.data)"
                v-tooltip.top="$t('users.edit')"
              />
              <Button
                icon="pi pi-trash"
                class="table-action-btn table-action-delete p-button-danger"
                @click="deleteRow(slotProps.data)"
                v-tooltip.top="$t('users.delete')"
              />
              <Button
                icon="pi pi-eye"
                class="table-action-btn table-action-view p-button-success"
