  ...
  <div class="table-page">
    <div class="table-wrapper">
      <div class="table-header">
        <h1 class="table-title">{{ $t("employee.title") }}</h1>
      ...
      >
        <Column field="id" :header="$t('employee.id')" class="col-identifier">
          ...
          <template #body="slotProps">
            <div class="table-actions-cell">
              <Button
                ...
                v-tooltip.top="$t('employee.edit')"
              />
              <Button
                icon="pi pi-trash"
                class="p-button-text p-button-sm p-button-danger"
                @click="deleteRow(slotProps.data)"
                v-tooltip.top="$t('employee.delete')"
              />
            </div>
          </template>
        </Column>
