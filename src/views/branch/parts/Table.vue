  ...
  <div class="table-page">
    <div class="table-wrapper">
      ...
      <div class="table-content responsive-table">
        ...
        >
          <Column field="id" :header="$t('branches.id')" class="col-identifier">
            ...
            <template #body="slotProps">
              <div class="table-actions-cell">
                ...
                <Button
                  ...
                  v-tooltip.top="$t('branches.viewBranch')"
                />
              </div>
            </template>
          </Column>
...
export default {
  ...
  computed: {
    propSearchUrl() {
      let url = `${moduleUrl.URLS.BRANCH.propSearchUrl}/${this.company_id}?paginate=true`;
  ...
  data() {
    return {
      propMainUrl: moduleUrl.URLS.BRANCH.propMainUrl,
    };
  },
